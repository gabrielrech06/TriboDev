        ...
        posts.map((post) => (
          <div className="post p-6 border-b border-neutral-600" key={post.id}>
            ...
            <div className="actions flex gap-4">
                <Link className="font-bold border border-white py-2 px-4 bg-blue-500 rounded-xl opacity-100 transition duration-300 delay-75 hover:bg-blue-400">Editar</Link>
                <button className="font-bold border border-white py-2 px-4 bg-red-500 rounded-xl opacity-100 transition duration-300 delay-75 hover:bg-red-400 cursor-pointer">Excluir</button>
            </div>
          </div>
        ))
      )}
