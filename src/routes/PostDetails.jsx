...
const PostDetail = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <Link to="/home" className="inline-block mb-6 text-neutral-50 hover:underline">
                &larr; Voltar para a página inicial
            </Link>

            <article className="bg-neutral-900 p-8 rounded-lg shadow-md">
                <h1 className="text-3xl font-bold mb-4">{post?.title || "Sem título"}</h1>
                {post?.author && <p className="text-gray-600 mb-2">Por: {post.author}</p>}
